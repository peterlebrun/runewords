/* Full disclosure: Using data from the following:
 ...
 * http://classic.battle.net/diablo2exp/items/runewords-111.shtml
 */
const runewords = [
    {
        name: "Ancient's Pledge",
        fits: "3 Socket Shields",
        runes : [ "ral", "ort", "tal" ],
        benefits: [
            "+50% Enhanced Defense",
            "Cold Resist +43%",
    ...
    {
        name: "Black",
        fits: "3 Socket Clubs/Hammers/Maces",
        runes: [ "thul", "io", "nef" ],
        benefits: [
            "+120% Enhanced Damage",
...
Ladder Rune Words 	Allowed Items 	Rune Order 	Completed Stats
